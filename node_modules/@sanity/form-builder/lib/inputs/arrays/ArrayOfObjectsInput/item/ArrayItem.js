...
var ArrayItem = /*#__PURE__*/(0, _react.memo)(function ArrayItem(props) {
  var _type$options, _type$options4;
  ...
  var isSortable = !readOnly && options.sortable !== false;
  ...
  var editForm = (0, _react.useMemo)(() => {
    ...
    return isReference && !isGrid ? form : /*#__PURE__*/_react.default.createElement(_EditPortal.EditPortal, {
      header: readOnly ? "View ".concat((itemType === null || itemType === void 0 ? void 0 : itemType.title) || '') : "Edit ".concat((itemType === null || itemType === void 0 ? void 0 : itemType.title) || ''),
  ...
  }, [ReferenceItemComponent, compareValue, filterField, focusPath, handleChange, handleEditClose, isEditing, isGrid, isReference, isSortable, itemMarkers, itemPresence, itemType, onBlur, onFocus, onInsert, readOnly, type === null || type === void 0 ? void 0 : (_type$options4 = type.options) === null || _type$options4 === void 0 ? void 0 : _type$options4.editModal, value]);
